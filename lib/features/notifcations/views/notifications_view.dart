...
class _NotificationsViewState extends State<NotificationsView> {
  final ValueNotifier<List<NotificationItem>> _notificationsNotifier =
      ValueNotifier<List<NotificationItem>>(NotificationData.getSampleNotifications());
            ...
            builder: (context, notifications, child) {
              ...
              return TextButton(
                ...
                child: "Mark all as read".txt(
                  size: 11.sp,
                  color: hasUnread ? Palette.montraPurple : Palette.greyColor,
                  fontW: F.w5,
                ),
              );
            },
              ...
              return Column(
                ...
                children: [
                  ...
                  ListView.separated(
                    ...
                    itemCount: (group['notifications'] as List<NotificationItem>).length,
                    separatorBuilder: (context, index) => 12.sbH,
                    itemBuilder: (context, notificationIndex) {
                      final notification = (group['notifications'] as List<NotificationItem>)[notificationIndex];
            ...
            child: Column(
              ...
              children: [
                Row(
                  children: [
                    Expanded(
                      child: notification.title.txt16(
                        fontW: F.w6,
                        color: notification.isRead 
                            ? Palette.blackColor 
                            : Palette.blackColor,
                ...
                Row(
                  ...
                  children: [
                    _formatTimestamp(notification.timestamp).txt12(
